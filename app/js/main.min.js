$((function(){$(".product__slider").slick({dots:!0,arrows:!1,infinite:!1,speed:900,slidesToShow:4,slidesToScroll:4}),$(".rate-star").rateYo({rating:5,starWidth:"12px",readOnly:!0}),$(".menu__btn").on("click",(function(){$(".menu__list").slideToggle()})),$(".header__btn-menu").on("click",(function(){$(".header-box").toggleClass("active"),$(".header__top-logo").toggleClass("logo-none")})),$(".tabs-stage .tab").hide(),$(".tabs-stage .tab:first-child").show(),$(".tabs-nav li:first").addClass("tab-active"),$(".tabs-nav a").on("click",(function(t){t.preventDefault();let e=$(this).parents(".tabs-container");$(".tabs-nav li",e).removeClass("tab-active"),$(this).parent().addClass("tab-active"),$(".tabs-stage .tab",e).hide(),$($(this).attr("href")).show()}));mixitup(".product__inner")})),
/**!
 * MixItUp v3.3.1
